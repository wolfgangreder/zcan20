...
public enum SpeedFlags
{
  ...
  /**
   * Speedflags. Bit 0..9 Speed Bit 10 Direction to System Bit 11 Direction from System Bit 15 Emergency stop
   *
  ...
  /**
   * Composes a mask from the collection {@code flags}. If conficting Flags are in the collection a
   * {@link java.lang.IllegalArgumentException} is thrown
   *
   * @param flags flags to mask
   * @return mask
   * @throws java.lang.IllegalArgumentException if illegal flag combinations are supplied
   * @see #setOfMask(short)
   */
