...
final class ModulePowerInfoRequestAdapterImpl extends AbstractPacketAdapter implements ModulePowerInfoRequestAdapter
{
  ...
  public static final class Factory implements PacketAdapterFactory<ModulePowerInfoRequestAdapter>
  {
    ...
    @Override
    public Class<? extends ModulePowerInfoRequestAdapter> type(Packet obj)
    {
