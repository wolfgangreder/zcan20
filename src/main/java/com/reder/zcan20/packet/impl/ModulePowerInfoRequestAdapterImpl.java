 ...
 */
public final class ModulePowerInfoRequestAdapterImpl extends AbstractPacketAdapter implements ModulePowerInfoRequestAdapter
{
  ...
  public ModulePowerInfoRequestAdapterImpl(Packet packet)
  {
    super(packet);
  }
