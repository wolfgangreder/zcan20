 ...
 */
public final class PowerInfoRequestAdapterImpl extends AbstractPacketAdapter implements PowerInfoRequestAdapter
{
  ...
  public PowerInfoRequestAdapterImpl(Packet packet)
  {
    super(packet);
  }
